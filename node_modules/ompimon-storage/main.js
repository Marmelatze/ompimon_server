...
_.extend(Storage.prototype, {
        ...
        data.forEach(function(rankData){
            _.each(rankData.counters, function(countVal, funcName) {
                tasks.push(function(callback) {
                    self._setCounterData(appId, rankData.rank, funcName, countVal, callback);
                });
            });

            rankData.data.forEach(function(sendData){
                self._setSendData(appId, rankData.rank, sendData, function(){});
                tasks.push(function(callback) {
                    self._setSendData(appId, rankData.rank, sendData, callback);
                });
            });
        });
        ...
        data.forEach(function(rankData){
            _.each(rankData.functions, function(sendDataList, funcName){
                _.each(sendDataList, function(sendData){
                    self._setSendDetailData(appId, rankData.rank, funcName, sendData, callback);
                });
            });
        });
    },
    ...
    getCounterFunctions: function(appId, callback){
        rclient.LLEN("app:"+appId+":counters", function(err, length){
            rclient.LRANGE("app:"+appId+":counters",0,length,function(err, list){
                callback(list);
            });
        });
    },
    ...
    getSendFunctions: function(appId, callback){
        rclient.LLEN("app:"+appId+":sends", function(err, length){
            rclient.LRANGE("app:"+appId+":sends",0,length,function(err, list){
                callback(list);
            });
        });
    },
    ...
    _publishMessage: function(appId, data){
        ...
        rclient.publish("client:app:"+appId, messageString);
    }
});
