...
_.extend(Storage.prototype, {
    ...
    getApplications: function(callback){
        rclient.SMEMBERS("apps", callback);
    },
     ...
     * @async
     */
    getCounterData: function(appId, counterId, callback){
        var self = this;
        var result = [];

        async.waterfall([
            function(callback){
                self.getCounterFunctions(appId, callback);
            },
            function(list, callback){
                _.each(list, function(funcName, funcId){
                    if(funcId != counterId){
                        return;
                    }
