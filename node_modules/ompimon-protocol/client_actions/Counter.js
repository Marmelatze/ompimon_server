 ...
 * ## Redis ##
 *
 * Gets messages from redis publish/subscribe by the {{#crossLink "Ompimon.Client.Client"}}client{{/crossLink}}.
...
_.extend(Counter.prototype, {
    ...
    /**
     * processes parsed data and starts listening for real time data.
     *
     * @method process
     * @param client {Ompimon.Client.Client}
     * @param data {Object}
    ...
    process: function (client, data) {
        ...
        Storage._getCounterFunctionById(data.appId, data.counterId, function(funcName) {
                ...
                messages.forEach(function (message) {
                    ...
                    if (null != funcName && message.funcName != funcName) {
                        return;
                    }
    ...
    /**
     * Get all counters from the db and summarize their values by rank.
     *
                ...
                data.forEach(function(counterData) {
                    counterData.forEach(function (counter) {
                        if (!result[counter.rank]) {
                            ...
                            result[counter.rank].value += parseInt(counter.value);
                        }
                    });
                });
