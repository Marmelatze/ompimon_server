var
    ...
    protocol = require("../../"),
    protoDataRequest = require('../../cluster_actions/data_request'),
...
module.exports = {
    testParse: function (test) {
        var parser = new Parser(stub.buildDataRequest(stub.requestData).get());
        var result = action.parse(client, parser);

        test.deepEqual(result, stub.requestData);
