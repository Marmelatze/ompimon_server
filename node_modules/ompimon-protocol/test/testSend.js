...
var protocol = require("ompimon-protocol"),
    Int64 = require('node-int64'),
    BufferBuilder = require("buffer-builder"),
    binary = require("binary"),
    Client = require("ompimon-cluster").client
    protoSend = require("../actions/send")
;
...
exports.testParse = function(test) {
    ...
    var result = action.parseFromCluster(buffer);
    test.deepEqual(data, result);
    test.done();
};

exports.testProcess = function(test) {
    action.processFromCluster(client, data, function(result) {
