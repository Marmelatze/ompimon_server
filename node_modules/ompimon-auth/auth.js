 ...
 * @param [type=http] {String} Can be one of http or test. Http authenticates against http backend.
 * @constructor
 */
function Auth(type) {
    eventEmitter.call(this);
    /**
     * Can be one of http or test. Http authenticates against http backend.
     * @property type
     * @type String
     * @default http
     */
